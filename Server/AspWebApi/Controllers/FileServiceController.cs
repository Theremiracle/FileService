...
namespace Server.AspWebApi.Controllers
{
    public class FileServiceController : ApiController
    {
        ...
        [HttpGet]
        [Route("api/file/image")]
        public HttpResponseMessage Get([FromUri] FileRequest fileReq)
        {
            try
            {
        ...
        [HttpDelete]
        [Route("api/file/image")]
        public async Task<HttpResponseMessage> Delete([FromUri] FileRequest fileReq)
        {
            try
            {
                var filePath = fileReq.FileFullName;
        ...
        [HttpPut]
        [Route("api/file/image")]
        public async Task<HttpResponseMessage> Update([FromUri] FileRequest fileReq)
        {
            try
            {
                var filePath = fileReq.FileFullName;
